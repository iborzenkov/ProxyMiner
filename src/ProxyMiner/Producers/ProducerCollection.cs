...
internal sealed class ProducerCollection : IProducerCollection
{
    ...
    public void Add(Producer producer)
    {
        ...
        if (_items.TryAdd(producer, new SourceTask(producer, _settings, SessionStart, SessionDone)))
        {
    ...
    private readonly ConcurrentDictionary<Producer, SourceTask> _items = new();
